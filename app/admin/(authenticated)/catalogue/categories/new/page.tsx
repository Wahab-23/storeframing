  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h2 className="text-2xl font-bold text-matt-black-100">Create New Category</h2>
          <p className="text-sm text-matt-black-300 mt-1">Add a new category to your catalogue</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-xl border border-matt-black-500/20 p-6 shadow-sm space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-sm font-semibold text-matt-black-100">Category Name *</label>
              <input
                type="text"
                required
                value={name}
