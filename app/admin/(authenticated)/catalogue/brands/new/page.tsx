...
export default function NewBrandPage() {
  ...
  // Load available products for tagging
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMsg("Brand successfully created! Redirecting...");
      setTimeout(() => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white-chalk-100/10 pb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-white-chalk-100/50 mt-0.5">
              Curate brand identity, official landing page hero banner, SEO tags, and tag catalog products.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 self-end sm:self-auto">
          ...
          >
            ...
            {isSubmitting ? "Creating Brand..." : "Save Brand"}
          </button>
        </div>
      </div>
                ...
                <table className="w-full text-xs text-left">
                  ...
                  <tbody className="divide-y divide-white-chalk-100/5">
                    {filteredProducts.map((p) => {
                      ...
                      const hasDifferentBrand = p.brand && p.brand.name;
                      return (
                        <tr
                          key={p.id}
