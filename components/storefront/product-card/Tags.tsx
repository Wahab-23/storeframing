...
const OldPriceRow = ({ value }: { value: number }) => {
    return (
        <div className="flex items-center gap-1 text-[11px] flex-none" style={{ height: ROW_H_STR }}>
            <span className="flex items-center justify-center rounded bg-sunflower-200 w-[18px] h-[18px]">
...
const RatingCount = ({ rating, reviews }: { rating?: number, reviews?: number }) => {
    return (
        <div className="flex items-center gap-1 text-[11px] flex-none" style={{ height: ROW_H_STR }}>
            <span className="flex items-center justify-center rounded w-[18px] h-[18px] bg-sunflower-200">
